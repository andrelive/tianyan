...
- core **1297**（+3 回归测试）· server **164** · tauri 13 · mcp 16 · 前端 409；clippy 0 / fmt 干净
- **判别力实证**：apply_patch 两处旧行为注入 → **恰好 2 个测试红**（其余 32 个照常绿）；页边界对齐注入"跳过对齐" → 2 个测试红；均已还原复绿
