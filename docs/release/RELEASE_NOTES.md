...
> 0.2.0 发布日期：2026-08-30 · 0.2.2/0.2.3 修复日期：2026-08-30 · 0.2.4 修复日期：2026-08-30 · 0.2.5 修复日期：2026-08-31 · 0.2.6 修复日期：2026-08-31 · 0.2.7 修复日期：2026-09-01

天演（Tianyan）是一个本地优先的通用智能助手：桌面应用（Tauri）+ 本地服务（Axum）+ 自进化智能体（VFS 统一知识/记忆/技能/规则）。

## 0.2.7 修复（后台任务与子智能体统一面板，ADR-026）
