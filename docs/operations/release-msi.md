...
- [ ] 三处版本一致：`tauri.conf.json`、`CHANGELOG.md`、`docs/release/RELEASE_NOTES.md`
      （`Cargo.toml` / `package.json` 的 `0.1.0` 属已知遗留，不影响 MSI，见 §1）。
...
- [ ] **版本号**：应用内“关于/更新检查”显示 `0.3.15`（与 MSI 版本一致）。
