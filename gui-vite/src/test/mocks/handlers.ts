...
export const mockTasks: BackgroundTask[] = [
  ...
  {
    id: 'task-cmd-1',
    description: 'python -m src.main --config configs/stage0_long.yaml',
    status: 'running',
    kind: 'command',
    parent_session_id: 'session-1',
    result: null,
    error: null,
    created_at: 1754395300000,
    completed_at: null,
    seq: 4,
  },
  {
  ...
  pending_approvals: [
    {
      ...
      action: { action_type: 'WriteFile', path: '/home/user/data.txt' },
      risk_level: 'High',
    ...
    },
    {
      ...
      action: { action_type: 'ExecuteCommand', command: 'rm -rf /tmp/cache' },
      risk_level: 'Critical',
  ...
  recent_records: [
    {
      request: {
        ...
        action: { action_type: 'WriteFile', path: '/home/user/old.txt' },
        risk_level: 'High',
...
export const mockTodos: TodoItem[] = [
  ...
  },
  {
    ...
    parent_id: null,
    session_id: 'session-1',
    created_at: 1753200003,
    updated_at: 1753200003,
    completed_at: 1753200003,
    due_at: null,
  },
];
